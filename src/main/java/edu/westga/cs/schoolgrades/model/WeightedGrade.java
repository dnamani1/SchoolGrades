...
public class WeightedGrade implements Grade {
	...
	/**
	 * Creates a WeightedGrade that decorates the given {@link Grade} by applying
	 * the given weight to it.
	 * 
	 * @param decoratedGrade the {@link Grade} to decorate. Must not be null
	 * @param weight         the weight to apply to decoratedGrade. Must be between
	 *                       0.0 and 1.0
	 */
